...
export default function Hero() {
    return (
        <div className={'overflow-hidden px-[30px] z-10'} style={{backgroundColor: '#073A45'}}>
            <div
                className={"overflow-hidden px-[30px] justify-between sm:px-[24px] flex flex-col md:flex-row sm:items-center"}>
                <div
                    className={'mt-[90px] mb-[40px] font-bold sm:mt-[70px] sm:w-full text-center md:text-left sm:mr-0 sm:items-center sm:justify-center'}>
                    <p className={'text-[20px] md:text-[40px]'}>Empowering <span style={{color: '#72DDD1'}}
                                                                                 className={'font-bold'}>Communities</span>,
                    </p>
                    <p className={"text-[20px] md:text-[40px]"}>Securing the <span
                        style={{color: '#72DDD1'}}>Future</span></p>
                    <p className={'text-[15px]  md:text-[25px] mt-5'}>
                        Redefining Community Finance, Empowering
                    </p>
            ...
            <div className={'mx-[60px] mt-7 '}>
                <Services image={viralMarketing} text1={'Decentralized ROSCAs'}
                          ...
                          text3={' ROSCA Community powered by blockchain'} text4={'Get Started'}/>
            </div>
            ...
            <div className={'my-[40px]'}>
                ...
                <div
                    className={'justify-items-center items-center mt-6 text-white text-[13px] md:text-[16px] flex flex-col md:gap-2 md:flex-row'}>
